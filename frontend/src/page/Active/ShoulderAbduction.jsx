...
export default function ShoulderAbduction({
    isRoutineMode = false,
    autoStart = true,
    presetTargetCount = 0,
    presetSide = "right",
            ...
            .then(res => {
                if (res.data) {
                    ...
                    if (mode) {
                        ...
                        // fallback ถ้าหา slug แยกข้างไม่เจอ ให้ใช้ ID จาก ROM Test (17, 18)
                        setTherapyId(selectedArm === 'right' ? 17 : 18);
                    }
                }
            })
            .catch(err => {
