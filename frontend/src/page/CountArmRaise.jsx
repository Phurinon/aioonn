...
export default function CountArmRaise() {
  ...
  const handleToggleTracking = async () => {
    if (mediapipeRef.current) {
      if (isTracking) {
        ...
        const score = mediapipeRef.current.getArmRaiseCount();
  ...
  return (
    <div className="w-full h-[calc(100vh-73px)] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center bg-[#F3FBFC] overflow-hidden relative">
        {/* จอกล้อง - ใช้ Mediapipe component พร้อม enableCounting */}
        ...
        {/* Count Display - Top Right (สไตล์ใหม่สวยกว่า) */}
        {isTracking && (
          <div className="absolute top-4 right-4 z-10 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg p-4 min-w-[140px]">
